    ...
    for(;;){
        ...
        if(fifo8_status(&keyinfo) + fifo8_status(&mouseinfo) 
            ...
            if(data == 0x1C){
                ...
                paint_string(sheet_control,sheet_win,40,28,buf,COL8_000000);
            }
            ...
            if(i != 0){
                ...
                paint_rectangle(back_buf,screen_lenth,COL8_FFFFFF,8,95,15,111);
            }else{
                timer_init(timer3,&timerinfo3,1);
                paint_rectangle(back_buf,screen_lenth,COL8_448CBB,8,95,15,111);
            }
            timer_settime(timer3,50);
            sheet_refresh(sheet_control,back_sheet,8,96,16,112);
        }
    }
}