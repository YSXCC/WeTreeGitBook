...
CMain:  ; Function begin
        ...
        mov     dword [esp+10H], ?_031                  ; 0088 _ C7. 44 24, 10, 00000000(d)
...
paint_string:; Function begin
        ...
        jmp     ?_019                                   ; 076B _ EB, 45

?_018:  mov     eax, dword [ebp+18H]                    ; 076D _ 8B. 45, 18
        movzx   eax, byte [eax]                         ; 0770 _ 0F B6. 00
        movsx   eax, al                                 ; 0773 _ 0F BE. C0
        shl     eax, 4                                  ; 0776 _ C1. E0, 04
        add     eax, systemFont                         ; 0779 _ 05, 00000000(d)
        mov     dword [esp+14H], 0                      ; 077E _ C7. 44 24, 14, 00000000
        mov     dword [esp+10H], eax                    ; 0786 _ 89. 44 24, 10
        mov     eax, dword [ebp+14H]                    ; 078A _ 8B. 45, 14
        mov     dword [esp+0CH], eax                    ; 078D _ 89. 44 24, 0C
        mov     eax, dword [ebp+10H]                    ; 0791 _ 8B. 45, 10
        mov     dword [esp+8H], eax                     ; 0794 _ 89. 44 24, 08
        mov     eax, dword [ebp+0CH]                    ; 0798 _ 8B. 45, 0C
        mov     dword [esp+4H], eax                     ; 079B _ 89. 44 24, 04
        mov     eax, dword [ebp+8H]                     ; 079F _ 8B. 45, 08
        mov     dword [esp], eax                        ; 07A2 _ 89. 04 24
        call    paint_font                              ; 07A5 _ E8, FFFFFFFC(rel)
        add     dword [ebp+10H], 8                      ; 07AA _ 83. 45, 10, 08
        add     dword [ebp+18H], 1                      ; 07AE _ 83. 45, 18, 01
?_019:  mov     eax, dword [ebp+18H]                    ; 07B2 _ 8B. 45, 18
        movzx   eax, byte [eax]                         ; 07B5 _ 0F B6. 00
        test    al, al                                  ; 07B8 _ 84. C0
        jnz     ?_018                                   ; 07BA _ 75, B1
        leave                                           ; 07BC _ C9
        ret                                             ; 07BD _ C3
...
init_mouse_cursor:; Function begin
        ...
        sub     esp, 20                                 ; 07C1 _ 83. EC, 14
        mov     eax, dword [ebp+0CH]                    ; 07C4 _ 8B. 45, 0C
        mov     byte [ebp-14H], al                      ; 07C7 _ 88. 45, EC
        mov     dword [ebp-8H], 0                       ; 07CA _ C7. 45, F8, 00000000
        jmp     ?_026                                   ; 07D1 _ E9, 0000009C

?_020:  mov     dword [ebp-4H], 0                       ; 07D6 _ C7. 45, FC, 00000000
        jmp     ?_025                                   ; 07DD _ E9, 00000082

?_021:  mov     eax, dword [ebp-8H]                     ; 07E2 _ 8B. 45, F8
        shl     eax, 4                                  ; 07E5 _ C1. E0, 04
        mov     edx, eax                                ; 07E8 _ 89. C2
        mov     eax, dword [ebp-4H]                     ; 07EA _ 8B. 45, FC
        add     eax, edx                                ; 07ED _ 01. D0
        add     eax, cursor.1505                        ; 07EF _ 05, 00000040(d)
        movzx   eax, byte [eax]                         ; 07F4 _ 0F B6. 00
        cmp     al, 42                                  ; 07F7 _ 3C, 2A
        jnz     ?_022                                   ; 07F9 _ 75, 19
        mov     eax, dword [ebp-8H]                     ; 07FB _ 8B. 45, F8
        shl     eax, 4                                  ; 07FE _ C1. E0, 04
        mov     edx, eax                                ; 0801 _ 89. C2
        mov     eax, dword [ebp-4H]                     ; 0803 _ 8B. 45, FC
        add     eax, edx                                ; 0806 _ 01. D0
        mov     edx, eax                                ; 0808 _ 89. C2
        mov     eax, dword [ebp+8H]                     ; 080A _ 8B. 45, 08
        add     eax, edx                                ; 080D _ 01. D0
        mov     byte [eax], 0                           ; 080F _ C6. 00, 00
        jmp     ?_024                                   ; 0812 _ EB, 4C

?_022:  mov     eax, dword [ebp-8H]                     ; 0814 _ 8B. 45, F8
        shl     eax, 4                                  ; 0817 _ C1. E0, 04
        mov     edx, eax                                ; 081A _ 89. C2
        mov     eax, dword [ebp-4H]                     ; 081C _ 8B. 45, FC
        add     eax, edx                                ; 081F _ 01. D0
        add     eax, cursor.1505                        ; 0821 _ 05, 00000040(d)
        movzx   eax, byte [eax]                         ; 0826 _ 0F B6. 00
        cmp     al, 79                                  ; 0829 _ 3C, 4F
        jnz     ?_023                                   ; 082B _ 75, 19
        mov     eax, dword [ebp-8H]                     ; 082D _ 8B. 45, F8
        shl     eax, 4                                  ; 0830 _ C1. E0, 04
        mov     edx, eax                                ; 0833 _ 89. C2
        mov     eax, dword [ebp-4H]                     ; 0835 _ 8B. 45, FC
        add     eax, edx                                ; 0838 _ 01. D0
        mov     edx, eax                                ; 083A _ 89. C2
        mov     eax, dword [ebp+8H]                     ; 083C _ 8B. 45, 08
        add     eax, edx                                ; 083F _ 01. D0
        mov     byte [eax], 7                           ; 0841 _ C6. 00, 07
        jmp     ?_024                                   ; 0844 _ EB, 1A

?_023:  mov     eax, dword [ebp-8H]                     ; 0846 _ 8B. 45, F8
        shl     eax, 4                                  ; 0849 _ C1. E0, 04
        mov     edx, eax                                ; 084C _ 89. C2
        mov     eax, dword [ebp-4H]                     ; 084E _ 8B. 45, FC
...
?_024:  add     dword [ebp-4H], 1                       ; 0860 _ 83. 45, FC, 01
?_025:  cmp     dword [ebp-4H], 15                      ; 0864 _ 83. 7D, FC, 0F
        jle     ?_021                                   ; 0868 _ 0F 8E, FFFFFF74
        add     dword [ebp-8H], 1                       ; 086E _ 83. 45, F8, 01
?_026:  cmp     dword [ebp-8H], 15                      ; 0872 _ 83. 7D, F8, 0F
        jle     ?_020                                   ; 0876 _ 0F 8E, FFFFFF5A
        leave                                           ; 087C _ C9
        ret                                             ; 087D _ C3
...
paint_block:; Function begin
        ...
        sub     esp, 16                                 ; 0881 _ 83. EC, 10
        mov     dword [ebp-8H], 0                       ; 0884 _ C7. 45, F8, 00000000
        jmp     ?_030                                   ; 088B _ EB, 50

?_027:  mov     dword [ebp-4H], 0                       ; 088D _ C7. 45, FC, 00000000
        jmp     ?_029                                   ; 0894 _ EB, 3B

?_028:  mov     eax, dword [ebp-8H]                     ; 0896 _ 8B. 45, F8
        mov     edx, dword [ebp+14H]                    ; 0899 _ 8B. 55, 14
        add     eax, edx                                ; 089C _ 01. D0
        imul    eax, dword [ebp+0CH]                    ; 089E _ 0F AF. 45, 0C
        mov     edx, dword [ebp-4H]                     ; 08A2 _ 8B. 55, FC
        mov     ecx, dword [ebp+10H]                    ; 08A5 _ 8B. 4D, 10
        add     edx, ecx                                ; 08A8 _ 01. CA
        add     eax, edx                                ; 08AA _ 01. D0
        mov     edx, eax                                ; 08AC _ 89. C2
        mov     eax, dword [ebp+8H]                     ; 08AE _ 8B. 45, 08
        add     edx, eax                                ; 08B1 _ 01. C2
        mov     eax, dword [ebp-8H]                     ; 08B3 _ 8B. 45, F8
        imul    eax, dword [ebp+18H]                    ; 08B6 _ 0F AF. 45, 18
        mov     ecx, eax                                ; 08BA _ 89. C1
        mov     eax, dword [ebp-4H]                     ; 08BC _ 8B. 45, FC
        add     eax, ecx                                ; 08BF _ 01. C8
        mov     ecx, eax                                ; 08C1 _ 89. C1
        mov     eax, dword [ebp+20H]                    ; 08C3 _ 8B. 45, 20
        add     eax, ecx                                ; 08C6 _ 01. C8
        movzx   eax, byte [eax]                         ; 08C8 _ 0F B6. 00
        mov     byte [edx], al                          ; 08CB _ 88. 02
        add     dword [ebp-4H], 1                       ; 08CD _ 83. 45, FC, 01
?_029:  mov     eax, dword [ebp-4H]                     ; 08D1 _ 8B. 45, FC
        cmp     eax, dword [ebp+18H]                    ; 08D4 _ 3B. 45, 18
        jl      ?_028                                   ; 08D7 _ 7C, BD
        add     dword [ebp-8H], 1                       ; 08D9 _ 83. 45, F8, 01
?_030:  mov     eax, dword [ebp-8H]                     ; 08DD _ 8B. 45, F8
        cmp     eax, dword [ebp+1CH]                    ; 08E0 _ 3B. 45, 1C
        jl      ?_027                                   ; 08E3 _ 7C, A8
        leave                                           ; 08E5 _ C9
        ret                                             ; 08E6 _ C3
