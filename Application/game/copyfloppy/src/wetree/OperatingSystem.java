...
public class OperatingSystem {
    ...
    public void makeFllopy() {
        ...
        // !文件系统测试 start
        // !特别注意写入的扇区位置
        DiskFileSystem fileSystem = new DiskFileSystem(floppyDisk, 7, 1);
        ...
        fileHeader = new FileHeader();
    	fileHeader.setFileName("ijk");
    	fileHeader.setFileExt("txt");
    	String content = "this is a text file with name ijk.txt";
    	fileHeader.setFileContent(content.getBytes());
    	fileSystem.addHeader(fileHeader);
